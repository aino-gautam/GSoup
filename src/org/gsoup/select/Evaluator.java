...
import org.gsoup.nodes.Comment;
import org.gsoup.nodes.Document;
import org.gsoup.nodes.DocumentType;
import org.gsoup.nodes.Element;
import org.gsoup.nodes.Node;
import org.gsoup.nodes.XmlDeclaration;
...
//            return String.format("%s", tagName);
            return StringFormat.format("%s", tagName);
        }
    }
...
//            return String.format("#%s", id);
            return StringFormat.format("#%s", id);
        }
...
//            return String.format(".%s", className);
            return StringFormat.format(".%s", className);
        }
...
//            return String.format("[%s]", key);
            return StringFormat.format("[%s]", key);
        }
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<org.gsoup.nodes.Attribute> values = element.attributes().asList();
            for (org.gsoup.nodes.Attribute attribute : values) {
...
//            return String.format("[^%s]", keyPrefix);
            return StringFormat.format("[^%s]", keyPrefix);
        }
...
//            return String.format("[%s=%s]", key, value);
            return StringFormat.format("[%s=%s]", key, value);
        }
...
//            return String.format("[%s*=%s]", key, value);
    ...
    public static final class AttributeWithValueMatching extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            return element.hasAttr(key) && pattern.test(element.attr(key));
        }

        @Override
        public String toString() {
//            return String.format("[%s~=%s]", key, pattern.toString());
            return StringFormat.format("[%s~=%s]", key, pattern.toString());
        }
...
//            return String.format(":lt(%d)", index);
            return StringFormat.format(":lt(%d)", index);
        }
...
//            return String.format(":gt(%d)", index);
            return StringFormat.format(":gt(%d)", index);
        }
...
//            return String.format(":eq(%d)", index);
            return StringFormat.format(":eq(%d)", index);
        }
...
//                return String.format(":%s(%d)",getPseudoClass(), b);
                return StringFormat.format(":%s(%d)",getPseudoClass(), b);
            }
            if (b == 0) {
//                return String.format(":%s(%dn)",getPseudoClass(), a);
                return StringFormat.format(":%s(%dn)",getPseudoClass(), a);
            }
//            return String.format(":%s(%dn%+d)", getPseudoClass(),a, b);
            return StringFormat.format(":%s(%dn%+d)", getPseudoClass(),a, b);
		}
...
//            return String.format(":contains(%s", searchText);
            return StringFormat.format(":contains(%s", searchText);
        }
    }
...
//            return String.format(":containsOwn(%s", searchText);
            return StringFormat.format(":containsOwn(%s", searchText);
        }
    }
    ...
    public static final class Matches extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            return pattern.test(element.text());
        }

        @Override
        public String toString() {
//            return String.format(":matches(%s", pattern);
            return StringFormat.format(":matches(%s", pattern);
        }
    }
    ...
    public static final class MatchesOwn extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            return pattern.test(element.ownText());
        }
