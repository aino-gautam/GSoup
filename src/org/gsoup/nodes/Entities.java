...
import org.gsoup.emul.CharsetEncoder;
...
public class Entities {
    ...
    private static final RegExp unescapePattern = RegExp.compile("&(#(x|X)?([0-9a-fA-F]+)|[a-zA-Z]+\\d*);?");
    private static final RegExp strictUnescapePattern = RegExp.compile("&(#(x|X)?([0-9a-fA-F]+)|[a-zA-Z]+\\d*);");
    ...
    private static Map<String, Character> loadEntities(String filename) {
        if(filename.equals("entities-base.properties")) {
            return EntitiesBase.getMap();
        } else if (filename.equals("entities-full.properties")) {
            return EntitiesFull.getMap();
        } else {
